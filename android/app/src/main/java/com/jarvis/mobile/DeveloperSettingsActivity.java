...
public final class DeveloperSettingsActivity extends Activity {
    @Override protected void onCreate(Bundle state) {
        ...
        body.addView(button("CLEAR SAVED API KEY", () -> { secrets.remove("provider_api_key"); status.setText(CortexProviderFactory.status(this)); Toast.makeText(this, "Saved API key removed.", Toast.LENGTH_SHORT).show(); }));
