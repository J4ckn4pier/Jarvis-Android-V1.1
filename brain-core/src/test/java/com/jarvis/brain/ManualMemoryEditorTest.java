...
public final class ManualMemoryEditorTest {
 public static void main(String[] args){
  ...
  e.addOrReplace("pref:coffee",MemoryType.PREFERENCE,"prefers dark roast",a); RichMemory m=s.current("pref:coffee",a).orElseThrow(); check(m.source().equals("manual-user-edit"),"manual provenance must be canonical manual-user-edit and distinct from user-stated"); check(m.confidence()==1.0,"manual explicit truth trusted");
