...
public final class BrainExitGateCompositionContractTest {
    public static void main(String[] args) throws Exception {
        ...
        require(gate, "AndroidCalendarEventCompositionContractTest.class", "structured Android calendar event composition must be part of the composed brain gate");
        require(gate, "AndroidAccessibilityToolBindingContractTest.class", "safe typed Android accessibility navigation and screen reading must be part of the composed brain gate");
        require(gate, "AndroidUiInteractionToolBindingContractTest.class", "approval-gated fail-closed Android tap/type interaction must be part of the composed brain gate");
        ...
        require(gate, "AndroidContactCallToolBindingContractTest.class", "exact approval-gated Android contact calling must be part of the composed brain gate");
