...
public final class AndroidActivityLogPersistenceContractTest {
    public static void main(String[] args) throws Exception {
        ...
        check(runtime.contains("new JarvisUiBackend(null, tools, connections, settings, defaultApps, lists, routines, activity)"),
                "frontend facade must receive the same durable activity log");
