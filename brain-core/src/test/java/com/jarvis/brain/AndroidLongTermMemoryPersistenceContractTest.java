...
public final class AndroidLongTermMemoryPersistenceContractTest {
    public static void main(String[] args) throws Exception {
        ...
        check(runtime.contains("new MemoryContextSource(memory"), "reasoning context must read the durable runtime-owned memory store");
        check(runtime.contains("new AssistantCore(brain, reasoning, tools, memoryContext)"), "AssistantCore must receive durable memory context");
