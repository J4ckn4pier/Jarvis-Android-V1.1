...
public final class DiningResearchCapabilityTest {
    public static void main(String[] args) {
        class FakeGateway implements ExternalResearchGateway {
            ...
            String lastCuisine = "";
            public ToolResult discoverPlaces(Map<String,String> a, ExecutionContext c) { lastCuisine=a.getOrDefault("cuisine",""); return ToolResult.success("places"); }
            ...
            public ToolResult getMenu(Map<String,String> a, ExecutionContext c) { menuCalls++; return ToolResult.success("Ribeye|52;Truffle mac|14|source=menu|observed_at=2026-08-28T17:00:00Z"); }
            public ToolResult attemptReservation(Map<String,String> a, ExecutionContext c) { reservationCalls++; return ToolResult.success("status=unavailable|available_times=18:00,18:45,20:30"); }
        }
        ...
        check(menuResult.status() == ToolResult.Status.SUCCESS, "menu lookup should delegate");
        ...
        check(reservationResult.status() == ToolResult.Status.SUCCESS, "booking adapter result should remain visible");
        ...
        check("Ethiopian".equals(gateway.lastCuisine), "arbitrary cuisine must pass unchanged");
